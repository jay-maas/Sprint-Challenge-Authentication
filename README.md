...
The purpose of using sessions is data persistance on the server.

2. What does bcrypt do to help us store passwords in a secure manner.

bcrypt hashes passwords more than once, and also compares the password for us when the function is called.

3. What does bcrypt do to slow down attackers?

We rely upon the dependency to be secure in many ways, but primarily an attacker is slowed down in the situation where it is unknown how many times a password was hashed, and without that key information it severly prolongs the attack.
